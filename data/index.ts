...
export const gridItems = [
  {
    ...
    className: 'row-span-1 md:col-span-2 md:row-span-2 auto-row-[18rem]',
    imgClassName: 'w-full h-full object-cover',
    titleClassName: 'justify-end h-full',
    img: '/cert2.jpg',
    spareImg: '',
  },
  {
...

  {
    ...
    className: 'sm:col-start-1 sm:col-end-3 sm:row-start-4 sm:row-end-5 md:col-span-2 md:row-span-2',
  ...
  },
  {
    ...
    className: 'md:col-span-1 md:row-span-1',
    imgClassName: '',
    titleClassName: 'justify-center items-center h-full w-full md:max-w-full max-w-60 text-center',
    img: '',
    spareImg: '',
  },
];
...
export const testimonials = [
  ...
  {
    quote:
      `Teaching Khaliun coding was a pleasure. She was one of the most hard-working and fast-learning students in the class. She would often struggle with coding, but never gave up.`,
